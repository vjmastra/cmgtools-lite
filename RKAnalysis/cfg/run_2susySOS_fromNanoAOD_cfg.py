...
if getHeppyOption("nanoPreProcessor"):
    if year == 2018:
        ...
        from CMGTools.RootTools.samples.samples_13TeV_DATA_test import dataSamples_17Jul2018 as allData
   ...
   #     from CMGTools.RootTools.samples.samples_13TeV_test import samples as mcSamples_
...
if year == 2018:
    ...
    if analysis == "main":
       ...
       # DatasetsAndTriggers.append( ("DoubleMuon", triggers["SOS_doublemulowMET"] + triggers["mumu_iso"] + triggers["3mu"]) )
        DatasetsAndTriggers.append( ("MET_Run2018A_14Dec2018", triggers["SOS_doublemulowMET"] + triggers["mumu_iso"] + triggers["3mu"]) )
