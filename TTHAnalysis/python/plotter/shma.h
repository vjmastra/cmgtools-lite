...
// Wed Sep 18 09:58:59 2019 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: /eos/cms/store/cmst3/group/tthlep/peruzzi/NanoTrees_SOS_230819_v5/2017/SMS_TChiWZ.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           GenPart_genPartIdxMother[204];   //[nGenPart]
   Int_t           GenPart_pdgId[204];   //[nGenPart]
   Int_t           GenPart_status[204];   //[nGenPart]
   Int_t           GenPart_statusFlags[204];   //[nGenPart]
   ...
   UInt_t          nJet;
   Float_t         Jet_area[40];   //[nJet]
   Float_t         Jet_btagCMVA[40];   //[nJet]
   Float_t         Jet_btagCSVV2[40];   //[nJet]
   Float_t         Jet_btagDeepB[40];   //[nJet]
   Float_t         Jet_btagDeepC[40];   //[nJet]
   Float_t         Jet_btagDeepFlavB[40];   //[nJet]
   Float_t         Jet_btagDeepFlavC[40];   //[nJet]
   Float_t         Jet_chEmEF[40];   //[nJet]
   Float_t         Jet_chHEF[40];   //[nJet]
   Float_t         Jet_eta[40];   //[nJet]
   Float_t         Jet_jercCHF[40];   //[nJet]
   Float_t         Jet_jercCHPUF[40];   //[nJet]
   Float_t         Jet_mass[40];   //[nJet]
   Float_t         Jet_muEF[40];   //[nJet]
   Float_t         Jet_muonSubtrFactor[40];   //[nJet]
   Float_t         Jet_neEmEF[40];   //[nJet]
   Float_t         Jet_neHEF[40];   //[nJet]
   Float_t         Jet_phi[40];   //[nJet]
   Float_t         Jet_pt[40];   //[nJet]
   Float_t         Jet_qgl[40];   //[nJet]
   Float_t         Jet_rawFactor[40];   //[nJet]
   Float_t         Jet_bRegCorr[40];   //[nJet]
   Float_t         Jet_bRegRes[40];   //[nJet]
   Int_t           Jet_electronIdx1[40];   //[nJet]
   Int_t           Jet_electronIdx2[40];   //[nJet]
   Int_t           Jet_jetId[40];   //[nJet]
   Int_t           Jet_muonIdx1[40];   //[nJet]
   Int_t           Jet_muonIdx2[40];   //[nJet]
   Int_t           Jet_nConstituents[40];   //[nJet]
   Int_t           Jet_nElectrons[40];   //[nJet]
   Int_t           Jet_nMuons[40];   //[nJet]
   Int_t           Jet_puId[40];   //[nJet]
   ...
   Int_t           TrigObj_id[45];   //[nTrigObj]
   Int_t           TrigObj_l1iso[45];   //[nTrigObj]
   Int_t           TrigObj_l1charge[45];   //[nTrigObj]
   ...
   Int_t           Jet_genJetIdx[40];   //[nJet]
   Int_t           Jet_hadronFlavour[40];   //[nJet]
   Int_t           Jet_partonFlavour[40];   //[nJet]
   ...
   Bool_t          GenModel_TChiWZ_ZToLL_250_25;
   Bool_t          GenModel_TChiWZ_ZToLL_175_165;
   Bool_t          GenModel_TChiWZ_ZToLL_225_210;
   Bool_t          GenModel_TChiWZ_ZToLL_150_140;
   Bool_t          GenModel_TChiWZ_ZToLL_225_205;
   UInt_t          prescaleFromSkim;
   UInt_t          nLepGood;
   UChar_t         LepGood_multiIsoId[7];   //[nLepGood]
   Float_t         LepGood_dzErr[7];   //[nLepGood]
   Float_t         LepGood_dr03EcalRecHitSumEt[7];   //[nLepGood]
   Bool_t          LepGood_mvaFall17V1Iso_WP90[7];   //[nLepGood]
   Float_t         LepGood_dxy[7];   //[nLepGood]
   Bool_t          LepGood_softId[7];   //[nLepGood]
   Float_t         LepGood_energyErr[7];   //[nLepGood]
   Int_t           LepGood_pdgId[7];   //[nLepGood]
   Float_t         LepGood_phi[7];   //[nLepGood]
   Float_t         LepGood_pfRelIso03_all[7];   //[nLepGood]
   Float_t         LepGood_miniPFRelIso_chg[7];   //[nLepGood]
   Int_t           LepGood_tightCharge[7];   //[nLepGood]
   Float_t         LepGood_jetRelIso[7];   //[nLepGood]
   UChar_t         LepGood_cleanmask[7];   //[nLepGood]
   Float_t         LepGood_ip3d[7];   //[nLepGood]
   Int_t           LepGood_nStations[7];   //[nLepGood]
   Bool_t          LepGood_mvaFall17V1Iso_WPL[7];   //[nLepGood]
   UChar_t         LepGood_mvaId[7];   //[nLepGood]
   Float_t         LepGood_mvaFall17V2Iso[7];   //[nLepGood]
   Float_t         LepGood_tunepRelPt[7];   //[nLepGood]
   Bool_t          LepGood_cutBased_HEEP[7];   //[nLepGood]
   Float_t         LepGood_hoe[7];   //[nLepGood]
   Float_t         LepGood_jetPtRelv2[7];   //[nLepGood]
   Bool_t          LepGood_convVeto[7];   //[nLepGood]
   Float_t         LepGood_pt[7];   //[nLepGood]
   Float_t         LepGood_miniPFRelIso_all[7];   //[nLepGood]
   Int_t           LepGood_vidNestedWPBitmap[7];   //[nLepGood]
   Float_t         LepGood_pfRelIso03_chg[7];   //[nLepGood]
   UChar_t         LepGood_lostHits[7];   //[nLepGood]
   Bool_t          LepGood_mvaFall17V2noIso_WPL[7];   //[nLepGood]
   Bool_t          LepGood_mvaFall17V1noIso_WP90[7];   //[nLepGood]
   Float_t         LepGood_dxyErr[7];   //[nLepGood]
   Bool_t          LepGood_mvaFall17V2Iso_WP80[7];   //[nLepGood]
   Int_t           LepGood_charge[7];   //[nLepGood]
   Float_t         LepGood_dr03TkSumPt[7];   //[nLepGood]
   Bool_t          LepGood_inTimeMuon[7];   //[nLepGood]
   Float_t         LepGood_mvaFall17V1noIso[7];   //[nLepGood]
   Float_t         LepGood_segmentComp[7];   //[nLepGood]
   Float_t         LepGood_mvaTTH[7];   //[nLepGood]
   Bool_t          LepGood_mvaFall17V1noIso_WP80[7];   //[nLepGood]
   Bool_t          LepGood_isPFcand[7];   //[nLepGood]
   Bool_t          LepGood_mvaFall17V1Iso_WP80[7];   //[nLepGood]
   Float_t         LepGood_dr03TkSumPtHEEP[7];   //[nLepGood]
   Bool_t          LepGood_triggerIdLoose[7];   //[nLepGood]
   Bool_t          LepGood_mvaFall17V2noIso_WP90[7];   //[nLepGood]
   Float_t         LepGood_eInvMinusPInv[7];   //[nLepGood]
   Bool_t          LepGood_mediumPromptId[7];   //[nLepGood]
   Bool_t          LepGood_softMvaId[7];   //[nLepGood]
   Int_t           LepGood_photonIdx[7];   //[nLepGood]
   Float_t         LepGood_mvaFall17V2noIso[7];   //[nLepGood]
   Float_t         LepGood_dr03HcalDepth1TowerSumEt[7];   //[nLepGood]
   Bool_t          LepGood_isGlobal[7];   //[nLepGood]
   Bool_t          LepGood_looseId[7];   //[nLepGood]
   Float_t         LepGood_mvaLowPt[7];   //[nLepGood]
   Int_t           LepGood_nTrackerLayers[7];   //[nLepGood]
   Float_t         LepGood_dz[7];   //[nLepGood]
   Bool_t          LepGood_isTracker[7];   //[nLepGood]
   Float_t         LepGood_sip3d[7];   //[nLepGood]
   UChar_t         LepGood_highPtId[7];   //[nLepGood]
   Float_t         LepGood_tkRelIso[7];   //[nLepGood]
   Bool_t          LepGood_tightId[7];   //[nLepGood]
   Bool_t          LepGood_mvaFall17V2Iso_WPL[7];   //[nLepGood]
   Float_t         LepGood_pfRelIso04_all[7];   //[nLepGood]
   UChar_t         LepGood_tkIsoId[7];   //[nLepGood]
   Float_t         LepGood_sieie[7];   //[nLepGood]
   Int_t           LepGood_cutBased[7];   //[nLepGood]
   Float_t         LepGood_deltaEtaSC[7];   //[nLepGood]
   Int_t           LepGood_cutBased_Fall17_V1[7];   //[nLepGood]
   Float_t         LepGood_ptErr[7];   //[nLepGood]
   Float_t         LepGood_r9[7];   //[nLepGood]
   Float_t         LepGood_eCorr[7];   //[nLepGood]
   UChar_t         LepGood_genPartFlav[7];   //[nLepGood]
   UChar_t         LepGood_pfIsoId[7];   //[nLepGood]
   UChar_t         LepGood_seedGain[7];   //[nLepGood]
   Float_t         LepGood_eta[7];   //[nLepGood]
   Float_t         LepGood_mass[7];   //[nLepGood]
   Bool_t          LepGood_mediumId[7];   //[nLepGood]
   Bool_t          LepGood_mvaFall17V2Iso_WP90[7];   //[nLepGood]
   Bool_t          LepGood_mvaFall17V1noIso_WPL[7];   //[nLepGood]
   Int_t           LepGood_genPartIdx[7];   //[nLepGood]
   Bool_t          LepGood_mvaFall17V2noIso_WP80[7];   //[nLepGood]
   Int_t           LepGood_jetIdx[7];   //[nLepGood]
   UChar_t         LepGood_miniIsoId[7];   //[nLepGood]
   Float_t         LepGood_mvaFall17V1Iso[7];   //[nLepGood]
   Float_t         puWeight;
   Float_t         puWeightUp;
   ...
   Float_t         LepGood_jetBTagDeepCSV[7];   //[nLepGood]
   Float_t         m2l;
   Float_t         m3l;
   Float_t         m4l;
   Float_t         mZ1;
   ...
   Float_t         minMllAFOS;
   Float_t         minMllAFAS;
   Bool_t          GenModel_TChiWZ_ZToLL_150_30;
   Bool_t          GenModel_TChiWZ_ZToLL_250_210;
   Bool_t          GenModel_TChiWZ_ZToLL_175_172;
   Bool_t          GenModel_TChiWZ_ZToLL_275_265;
   Bool_t          GenModel_TChiWZ_ZToLL_100_97;
   Bool_t          GenModel_TChiWZ_ZToLL_300_299;
   Bool_t          GenModel_TChiWZ_ZToLL_200_192;
   Bool_t          GenModel_TChiWZ_ZToLL_125_95;
   Bool_t          GenModel_TChiWZ_ZToLL_325_1;
   Bool_t          GenModel_TChiWZ_ZToLL_225_224;
   Bool_t          GenModel_TChiWZ_ZToLL_200_185;
   Bool_t          GenModel_TChiWZ_ZToLL_225_135;
   Bool_t          GenModel_TChiWZ_ZToLL_150_20;
   Bool_t          GenModel_TChiWZ_ZToLL_300_170;
   Bool_t          GenModel_TChiWZ_ZToLL_125_65;
   Bool_t          GenModel_TChiWZ_ZToLL_225_185;
   Bool_t          GenModel_TChiWZ_ZToLL_300_292;
   Bool_t          GenModel_TChiWZ_ZToLL_300_297;
   Bool_t          GenModel_TChiWZ_ZToLL_125_122;
   Bool_t          GenModel_TChiWZ_ZToLL_275_235;
   Bool_t          GenModel_TChiWZ_ZToLL_250_242;
   Bool_t          GenModel_TChiWZ_ZToLL_250_240;
   Bool_t          GenModel_TChiWZ_ZToLL_200_140;
   Bool_t          GenModel_TChiWZ_ZToLL_150_145;
   Bool_t          GenModel_TChiWZ_ZToLL_325_295;
   Bool_t          GenModel_TChiWZ_ZToLL_175_105;
   Bool_t          GenModel_TChiWZ_ZToLL_175_160;
   Bool_t          GenModel_TChiWZ_ZToLL_250_170;
   Bool_t          GenModel_TChiWZ_ZToLL_300_285;
   Bool_t          GenModel_TChiWZ_ZToLL_150_120;
   Bool_t          GenModel_TChiWZ_ZToLL_325_265;
   Bool_t          GenModel_TChiWZ_ZToLL_275_175;
   Bool_t          GenModel_TChiWZ_ZToLL_225_50;
   Bool_t          GenModel_TChiWZ_ZToLL_275_205;
   Bool_t          GenModel_TChiWZ_ZToLL_300_260;
   Bool_t          GenModel_TChiWZ_ZToLL_325_75;
   Bool_t          GenModel_TChiWZ_ZToLL_300_75;
   Bool_t          GenModel_TChiWZ_ZToLL_175_135;
   Bool_t          GenModel_TChiWZ_ZToLL_250_160;
   Bool_t          GenModel_TChiWZ_ZToLL_275_75;
   Bool_t          GenModel_TChiWZ_ZToLL_275_225;
   Bool_t          GenModel_TChiWZ_ZToLL_275_145;
   Bool_t          GenModel_TChiWZ_ZToLL_250_180;
   Bool_t          GenModel_TChiWZ_ZToLL_300_190;
   Bool_t          GenModel_TChiWZ_ZToLL_275_255;
   Bool_t          GenModel_TChiWZ_ZToLL_300_270;
   Bool_t          GenModel_TChiWZ_ZToLL_275_270;
   Bool_t          GenModel_TChiWZ_ZToLL_275_272;
   Bool_t          GenModel_TChiWZ_ZToLL_125_117;
   Bool_t          GenModel_TChiWZ_ZToLL_325_100;
   Bool_t          GenModel_TChiWZ_ZToLL_225_145;
   Bool_t          GenModel_TChiWZ_ZToLL_300_180;
   Bool_t          GenModel_TChiWZ_ZToLL_100_30;
   Bool_t          GenModel_TChiWZ_ZToLL_250_200;
   Bool_t          GenModel_TChiWZ_ZToLL_125_110;
   Bool_t          GenModel_TChiWZ_ZToLL_250_220;
   Bool_t          GenModel_TChiWZ_ZToLL_275_260;
   Bool_t          GenModel_TChiWZ_ZToLL_300_210;
   Bool_t          GenModel_TChiWZ_ZToLL_325_225;
   Bool_t          GenModel_TChiWZ_ZToLL_275_165;
   Bool_t          GenModel_TChiWZ_ZToLL_200_197;
   Bool_t          GenModel_TChiWZ_ZToLL_250_247;
   Bool_t          GenModel_TChiWZ_ZToLL_100_92;
   Bool_t          GenModel_TChiWZ_ZToLL_100_80;
   Bool_t          GenModel_TChiWZ_ZToLL_250_235;
   Bool_t          GenModel_TChiWZ_ZToLL_225_195;
   Bool_t          GenModel_TChiWZ_ZToLL_225_215;
   Bool_t          GenModel_TChiWZ_ZToLL_100_40;
   Bool_t          GenModel_TChiWZ_ZToLL_175_85;
   Bool_t          GenModel_TChiWZ_ZToLL_225_125;
   Bool_t          GenModel_TChiWZ_ZToLL_275_50;
   Bool_t          GenModel_TChiWZ_ZToLL_125_35;
   Bool_t          GenModel_TChiWZ_ZToLL_150_135;
   Bool_t          GenModel_TChiWZ_ZToLL_275_274;
   Bool_t          GenModel_TChiWZ_ZToLL_300_295;
   Bool_t          GenModel_TChiWZ_ZToLL_250_1;
   Bool_t          GenModel_TChiWZ_ZToLL_200_1;
   Bool_t          GenModel_TChiWZ_ZToLL_275_215;
   Bool_t          GenModel_TChiWZ_ZToLL_325_175;
   Bool_t          GenModel_TChiWZ_ZToLL_150_147;
   Bool_t          GenModel_TChiWZ_ZToLL_100_70;
   Bool_t          GenModel_TChiWZ_ZToLL_225_222;
   Bool_t          GenModel_TChiWZ_ZToLL_325_245;
   Bool_t          GenModel_TChiWZ_ZToLL_325_50;
   Bool_t          GenModel_TChiWZ_ZToLL_175_125;
   Bool_t          GenModel_TChiWZ_ZToLL_200_120;
   Bool_t          GenModel_TChiWZ_ZToLL_325_235;
   Bool_t          GenModel_TChiWZ_ZToLL_250_190;
   Bool_t          GenModel_TChiWZ_ZToLL_300_250;
   Bool_t          GenModel_TChiWZ_ZToLL_100_10;
   Bool_t          GenModel_TChiWZ_ZToLL_200_190;
   Bool_t          GenModel_TChiWZ_ZToLL_225_85;
   Bool_t          GenModel_TChiWZ_ZToLL_175_145;
   Bool_t          GenModel_TChiWZ_ZToLL_150_10;
   Bool_t          GenModel_TChiWZ_ZToLL_175_170;
   Bool_t          GenModel_TChiWZ_ZToLL_200_170;
   Bool_t          GenModel_TChiWZ_ZToLL_275_125;
   Bool_t          GenModel_TChiWZ_ZToLL_275_155;
   Bool_t          GenModel_TChiWZ_ZToLL_175_174;
   Bool_t          GenModel_TChiWZ_ZToLL_100_50;
   Bool_t          GenModel_TChiWZ_ZToLL_300_125;
   Bool_t          GenModel_TChiWZ_ZToLL_300_280;
   Bool_t          GenModel_TChiWZ_ZToLL_250_230;
   Bool_t          GenModel_TChiWZ_ZToLL_175_65;
   Bool_t          GenModel_TChiWZ_ZToLL_125_115;
   Bool_t          GenModel_TChiWZ_ZToLL_275_135;
   Bool_t          GenModel_TChiWZ_ZToLL_100_95;
   Bool_t          GenModel_TChiWZ_ZToLL_325_215;
   Bool_t          GenModel_TChiWZ_ZToLL_275_195;
   Bool_t          GenModel_TChiWZ_ZToLL_225_220;
   Bool_t          GenModel_TChiWZ_ZToLL_200_70;
   Bool_t          GenModel_TChiWZ_ZToLL_300_290;
   Bool_t          GenModel_TChiWZ_ZToLL_250_140;
   Bool_t          GenModel_TChiWZ_ZToLL_300_200;
   Bool_t          GenModel_TChiWZ_ZToLL_125_75;
   Bool_t          GenModel_TChiWZ_ZToLL_125_120;
   Bool_t          GenModel_TChiWZ_ZToLL_150_100;
   Bool_t          GenModel_TChiWZ_ZToLL_300_160;
   Bool_t          GenModel_TChiWZ_ZToLL_275_267;
   Bool_t          GenModel_TChiWZ_ZToLL_100_85;
   Bool_t          GenModel_TChiWZ_ZToLL_250_245;
   Bool_t          GenModel_TChiWZ_ZToLL_225_105;
   Bool_t          GenModel_TChiWZ_ZToLL_200_160;
   Bool_t          GenModel_TChiWZ_ZToLL_225_175;
   Bool_t          GenModel_TChiWZ_ZToLL_300_1;
   Bool_t          GenModel_TChiWZ_ZToLL_150_40;
   Bool_t          GenModel_TChiWZ_ZToLL_225_25;
   Bool_t          GenModel_TChiWZ_ZToLL_275_100;
   Bool_t          GenModel_TChiWZ_ZToLL_200_150;
   Bool_t          GenModel_TChiWZ_ZToLL_200_195;
   Bool_t          GenModel_TChiWZ_ZToLL_250_110;
   Bool_t          GenModel_TChiWZ_ZToLL_100_90;
   Bool_t          GenModel_TChiWZ_ZToLL_300_150;
   Bool_t          GenModel_TChiWZ_ZToLL_325_285;
   Bool_t          GenModel_TChiWZ_ZToLL_325_125;
   Bool_t          GenModel_TChiWZ_ZToLL_200_100;
   Bool_t          GenModel_TChiWZ_ZToLL_175_1;
   Bool_t          GenModel_TChiWZ_ZToLL_325_25;
   Bool_t          GenModel_TChiWZ_ZToLL_225_217;
   Bool_t          GenModel_TChiWZ_ZToLL_250_249;
   Bool_t          GenModel_TChiWZ_ZToLL_200_110;
   Bool_t          GenModel_TChiWZ_ZToLL_225_165;
   Bool_t          GenModel_TChiWZ_ZToLL_275_245;
   Bool_t          GenModel_TChiWZ_ZToLL_125_5;
   Bool_t          GenModel_TChiWZ_ZToLL_250_130;
   Bool_t          GenModel_TChiWZ_ZToLL_125_45;
   Bool_t          GenModel_TChiWZ_ZToLL_300_50;
   Bool_t          GenModel_TChiWZ_ZToLL_100_60;
   Bool_t          GenModel_TChiWZ_ZToLL_125_105;
   Bool_t          GenModel_TChiWZ_ZToLL_250_100;
   Bool_t          GenModel_TChiWZ_ZToLL_200_25;
   Bool_t          GenModel_TChiWZ_ZToLL_150_149;
   Bool_t          GenModel_TChiWZ_ZToLL_100_1;
   Bool_t          GenModel_TChiWZ_ZToLL_200_199;
   Bool_t          GenModel_TChiWZ_ZToLL_175_25;
   Bool_t          GenModel_TChiWZ_ZToLL_150_110;
   Bool_t          GenModel_TChiWZ_ZToLL_175_167;
   Bool_t          GenModel_TChiWZ_ZToLL_225_115;
   Bool_t          GenModel_TChiWZ_ZToLL_100_20;
   Bool_t          GenModel_TChiWZ_ZToLL_325_205;
   Bool_t          GenModel_TChiWZ_ZToLL_175_155;
   Bool_t          GenModel_TChiWZ_ZToLL_300_25;
   Bool_t          GenModel_TChiWZ_ZToLL_325_275;
   Bool_t          GenModel_TChiWZ_ZToLL_125_85;
   Bool_t          GenModel_TChiWZ_ZToLL_275_1;
   Bool_t          GenModel_TChiWZ_ZToLL_325_185;
   Bool_t          GenModel_TChiWZ_ZToLL_300_240;
   Bool_t          GenModel_TChiWZ_ZToLL_300_220;
   Bool_t          GenModel_TChiWZ_ZToLL_225_155;
   Bool_t          GenModel_TChiWZ_ZToLL_125_124;
   Bool_t          GenModel_TChiWZ_ZToLL_200_90;
   Bool_t          GenModel_TChiWZ_ZToLL_225_75;
   Bool_t          GenModel_TChiWZ_ZToLL_250_50;
   Bool_t          GenModel_TChiWZ_ZToLL_150_70;
   Bool_t          GenModel_TChiWZ_ZToLL_200_130;
   Bool_t          GenModel_TChiWZ_ZToLL_125_15;
   Bool_t          GenModel_TChiWZ_ZToLL_125_25;
   Bool_t          GenModel_TChiWZ_ZToLL_200_180;
   Bool_t          GenModel_TChiWZ_ZToLL_150_90;
   Bool_t          GenModel_TChiWZ_ZToLL_275_185;
   Bool_t          GenModel_TChiWZ_ZToLL_325_150;
   Bool_t          GenModel_TChiWZ_ZToLL_125_55;
   Bool_t          GenModel_TChiWZ_ZToLL_175_35;
   Bool_t          GenModel_TChiWZ_ZToLL_325_255;
   Bool_t          GenModel_TChiWZ_ZToLL_250_120;
   Bool_t          GenModel_TChiWZ_ZToLL_300_230;
   Bool_t          GenModel_TChiWZ_ZToLL_200_80;
   Bool_t          GenModel_TChiWZ_ZToLL_225_95;
   Bool_t          GenModel_TChiWZ_ZToLL_150_142;
   Bool_t          GenModel_TChiWZ_ZToLL_325_195;
   Bool_t          GenModel_TChiWZ_ZToLL_250_150;
   Bool_t          GenModel_TChiWZ_ZToLL_175_115;
   Bool_t          GenModel_TChiWZ_ZToLL_175_95;
   Bool_t          GenModel_TChiWZ_ZToLL_200_60;
   Bool_t          GenModel_TChiWZ_ZToLL_200_50;
   Bool_t          GenModel_TChiWZ_ZToLL_225_1;
   Bool_t          GenModel_TChiWZ_ZToLL_300_100;
   Bool_t          GenModel_TChiWZ_ZToLL_175_55;
   Bool_t          GenModel_TChiWZ_ZToLL_150_50;
   Bool_t          GenModel_TChiWZ_ZToLL_175_75;
   Bool_t          GenModel_TChiWZ_ZToLL_150_80;
   Bool_t          GenModel_TChiWZ_ZToLL_100_99;
   Bool_t          GenModel_TChiWZ_ZToLL_150_130;
   Bool_t          GenModel_TChiWZ_ZToLL_250_75;
   Bool_t          GenModel_TChiWZ_ZToLL_150_60;
   Bool_t          GenModel_TChiWZ_ZToLL_175_45;
   Bool_t          GenModel_TChiWZ_ZToLL_275_25;
   Bool_t          GenModel_TChiWZ_ZToLL_150_1;
   ...
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_25;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_165;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_210;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_140;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_205;   //!
   TBranch        *b_prescaleFromSkim;   //!
   TBranch        *b_nLepGood;   //!
   TBranch        *b_LepGood_multiIsoId;   //!
   TBranch        *b_LepGood_dzErr;   //!
   TBranch        *b_LepGood_dr03EcalRecHitSumEt;   //!
   TBranch        *b_LepGood_mvaFall17V1Iso_WP90;   //!
   TBranch        *b_LepGood_dxy;   //!
   TBranch        *b_LepGood_softId;   //!
   TBranch        *b_LepGood_energyErr;   //!
   TBranch        *b_LepGood_pdgId;   //!
   TBranch        *b_LepGood_phi;   //!
   TBranch        *b_LepGood_pfRelIso03_all;   //!
   TBranch        *b_LepGood_miniPFRelIso_chg;   //!
   TBranch        *b_LepGood_tightCharge;   //!
   TBranch        *b_LepGood_jetRelIso;   //!
   TBranch        *b_LepGood_cleanmask;   //!
   TBranch        *b_LepGood_ip3d;   //!
   TBranch        *b_LepGood_nStations;   //!
   TBranch        *b_LepGood_mvaFall17V1Iso_WPL;   //!
   TBranch        *b_LepGood_mvaId;   //!
   TBranch        *b_LepGood_mvaFall17V2Iso;   //!
   TBranch        *b_LepGood_tunepRelPt;   //!
   TBranch        *b_LepGood_cutBased_HEEP;   //!
   TBranch        *b_LepGood_hoe;   //!
   TBranch        *b_LepGood_jetPtRelv2;   //!
   TBranch        *b_LepGood_convVeto;   //!
   TBranch        *b_LepGood_pt;   //!
   TBranch        *b_LepGood_miniPFRelIso_all;   //!
   TBranch        *b_LepGood_vidNestedWPBitmap;   //!
   TBranch        *b_LepGood_pfRelIso03_chg;   //!
   TBranch        *b_LepGood_lostHits;   //!
   TBranch        *b_LepGood_mvaFall17V2noIso_WPL;   //!
   TBranch        *b_LepGood_mvaFall17V1noIso_WP90;   //!
   TBranch        *b_LepGood_dxyErr;   //!
   TBranch        *b_LepGood_mvaFall17V2Iso_WP80;   //!
   TBranch        *b_LepGood_charge;   //!
   TBranch        *b_LepGood_dr03TkSumPt;   //!
   TBranch        *b_LepGood_inTimeMuon;   //!
   TBranch        *b_LepGood_mvaFall17V1noIso;   //!
   TBranch        *b_LepGood_segmentComp;   //!
   TBranch        *b_LepGood_mvaTTH;   //!
   TBranch        *b_LepGood_mvaFall17V1noIso_WP80;   //!
   TBranch        *b_LepGood_isPFcand;   //!
   TBranch        *b_LepGood_mvaFall17V1Iso_WP80;   //!
   TBranch        *b_LepGood_dr03TkSumPtHEEP;   //!
   TBranch        *b_LepGood_triggerIdLoose;   //!
   TBranch        *b_LepGood_mvaFall17V2noIso_WP90;   //!
   TBranch        *b_LepGood_eInvMinusPInv;   //!
   TBranch        *b_LepGood_mediumPromptId;   //!
   TBranch        *b_LepGood_softMvaId;   //!
   TBranch        *b_LepGood_photonIdx;   //!
   TBranch        *b_LepGood_mvaFall17V2noIso;   //!
   TBranch        *b_LepGood_dr03HcalDepth1TowerSumEt;   //!
   TBranch        *b_LepGood_isGlobal;   //!
   TBranch        *b_LepGood_looseId;   //!
   TBranch        *b_LepGood_mvaLowPt;   //!
   TBranch        *b_LepGood_nTrackerLayers;   //!
   TBranch        *b_LepGood_dz;   //!
   TBranch        *b_LepGood_isTracker;   //!
   TBranch        *b_LepGood_sip3d;   //!
   TBranch        *b_LepGood_highPtId;   //!
   TBranch        *b_LepGood_tkRelIso;   //!
   TBranch        *b_LepGood_tightId;   //!
   TBranch        *b_LepGood_mvaFall17V2Iso_WPL;   //!
   TBranch        *b_LepGood_pfRelIso04_all;   //!
   TBranch        *b_LepGood_tkIsoId;   //!
   TBranch        *b_LepGood_sieie;   //!
   TBranch        *b_LepGood_cutBased;   //!
   TBranch        *b_LepGood_deltaEtaSC;   //!
   TBranch        *b_LepGood_cutBased_Fall17_V1;   //!
   TBranch        *b_LepGood_ptErr;   //!
   TBranch        *b_LepGood_r9;   //!
   TBranch        *b_LepGood_eCorr;   //!
   TBranch        *b_LepGood_genPartFlav;   //!
   TBranch        *b_LepGood_pfIsoId;   //!
   TBranch        *b_LepGood_seedGain;   //!
   TBranch        *b_LepGood_eta;   //!
   TBranch        *b_LepGood_mass;   //!
   TBranch        *b_LepGood_mediumId;   //!
   TBranch        *b_LepGood_mvaFall17V2Iso_WP90;   //!
   TBranch        *b_LepGood_mvaFall17V1noIso_WPL;   //!
   TBranch        *b_LepGood_genPartIdx;   //!
   TBranch        *b_LepGood_mvaFall17V2noIso_WP80;   //!
   TBranch        *b_LepGood_jetIdx;   //!
   TBranch        *b_LepGood_miniIsoId;   //!
   TBranch        *b_LepGood_mvaFall17V1Iso;   //!
   TBranch        *b_puWeight;   //!
   ...
   TBranch        *b_LepGood_jetBTagDeepCSV;   //!
   TBranch        *b_m2l;   //!
   TBranch        *b_m3l;   //!
   TBranch        *b_m4l;   //!
   TBranch        *b_mZ1;   //!
   ...
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_30;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_210;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_172;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_265;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_100_97;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_299;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_192;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_125_95;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_1;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_224;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_185;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_135;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_20;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_170;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_125_65;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_185;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_292;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_297;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_125_122;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_235;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_242;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_240;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_140;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_145;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_295;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_105;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_160;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_170;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_285;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_120;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_265;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_175;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_50;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_205;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_260;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_75;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_75;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_135;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_160;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_75;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_225;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_145;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_180;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_190;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_255;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_270;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_270;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_272;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_125_117;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_100;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_145;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_180;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_100_30;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_200;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_125_110;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_220;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_260;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_210;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_225;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_165;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_197;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_247;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_100_92;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_100_80;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_235;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_195;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_215;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_100_40;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_85;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_125;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_50;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_125_35;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_135;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_274;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_295;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_1;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_1;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_215;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_175;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_147;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_100_70;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_222;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_245;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_50;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_125;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_120;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_235;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_190;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_250;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_100_10;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_190;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_85;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_145;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_10;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_170;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_170;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_125;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_155;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_174;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_100_50;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_125;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_280;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_230;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_65;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_125_115;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_135;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_100_95;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_215;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_195;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_220;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_70;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_290;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_140;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_200;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_125_75;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_125_120;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_100;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_160;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_267;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_100_85;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_245;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_105;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_160;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_175;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_1;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_40;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_25;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_100;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_150;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_195;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_110;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_100_90;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_150;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_285;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_125;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_100;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_1;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_25;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_217;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_249;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_110;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_165;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_245;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_125_5;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_130;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_125_45;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_50;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_100_60;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_125_105;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_100;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_25;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_149;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_100_1;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_199;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_25;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_110;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_167;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_115;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_100_20;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_205;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_155;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_25;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_275;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_125_85;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_1;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_185;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_240;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_220;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_155;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_125_124;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_90;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_75;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_50;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_70;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_130;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_125_15;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_125_25;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_180;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_90;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_185;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_150;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_125_55;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_35;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_255;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_120;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_230;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_80;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_95;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_142;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_325_195;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_150;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_115;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_95;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_60;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_200_50;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_225_1;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_300_100;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_55;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_50;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_75;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_80;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_100_99;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_130;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_250_75;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_60;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_175_45;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_275_25;   //!
   TBranch        *b_GenModel_TChiWZ_ZToLL_150_1;   //!
...
#ifdef shma_cxx
shma::shma(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/cmst3/group/tthlep/peruzzi/NanoTrees_SOS_230819_v5/2017/SMS_TChiWZ.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/cmst3/group/tthlep/peruzzi/NanoTrees_SOS_230819_v5/2017/SMS_TChiWZ.root");
      }
...
Int_t shma::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t shma::LoadTree(Long64_t entry)
{
...
void shma::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_25", &GenModel_TChiWZ_ZToLL_250_25, &b_GenModel_TChiWZ_ZToLL_250_25);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_165", &GenModel_TChiWZ_ZToLL_175_165, &b_GenModel_TChiWZ_ZToLL_175_165);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_210", &GenModel_TChiWZ_ZToLL_225_210, &b_GenModel_TChiWZ_ZToLL_225_210);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_140", &GenModel_TChiWZ_ZToLL_150_140, &b_GenModel_TChiWZ_ZToLL_150_140);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_205", &GenModel_TChiWZ_ZToLL_225_205, &b_GenModel_TChiWZ_ZToLL_225_205);
   fChain->SetBranchAddress("prescaleFromSkim", &prescaleFromSkim, &b_prescaleFromSkim);
   fChain->SetBranchAddress("nLepGood", &nLepGood, &b_nLepGood);
   fChain->SetBranchAddress("LepGood_multiIsoId", LepGood_multiIsoId, &b_LepGood_multiIsoId);
   fChain->SetBranchAddress("LepGood_dzErr", LepGood_dzErr, &b_LepGood_dzErr);
   fChain->SetBranchAddress("LepGood_dr03EcalRecHitSumEt", LepGood_dr03EcalRecHitSumEt, &b_LepGood_dr03EcalRecHitSumEt);
   fChain->SetBranchAddress("LepGood_mvaFall17V1Iso_WP90", LepGood_mvaFall17V1Iso_WP90, &b_LepGood_mvaFall17V1Iso_WP90);
   fChain->SetBranchAddress("LepGood_dxy", LepGood_dxy, &b_LepGood_dxy);
   fChain->SetBranchAddress("LepGood_softId", LepGood_softId, &b_LepGood_softId);
   fChain->SetBranchAddress("LepGood_energyErr", LepGood_energyErr, &b_LepGood_energyErr);
   ...
   fChain->SetBranchAddress("LepGood_pfRelIso03_all", LepGood_pfRelIso03_all, &b_LepGood_pfRelIso03_all);
   fChain->SetBranchAddress("LepGood_miniPFRelIso_chg", LepGood_miniPFRelIso_chg, &b_LepGood_miniPFRelIso_chg);
   fChain->SetBranchAddress("LepGood_tightCharge", LepGood_tightCharge, &b_LepGood_tightCharge);
   fChain->SetBranchAddress("LepGood_jetRelIso", LepGood_jetRelIso, &b_LepGood_jetRelIso);
   fChain->SetBranchAddress("LepGood_cleanmask", LepGood_cleanmask, &b_LepGood_cleanmask);
   ...
   fChain->SetBranchAddress("LepGood_mvaFall17V1Iso_WPL", LepGood_mvaFall17V1Iso_WPL, &b_LepGood_mvaFall17V1Iso_WPL);
   fChain->SetBranchAddress("LepGood_mvaId", LepGood_mvaId, &b_LepGood_mvaId);
   fChain->SetBranchAddress("LepGood_mvaFall17V2Iso", LepGood_mvaFall17V2Iso, &b_LepGood_mvaFall17V2Iso);
   fChain->SetBranchAddress("LepGood_tunepRelPt", LepGood_tunepRelPt, &b_LepGood_tunepRelPt);
   fChain->SetBranchAddress("LepGood_cutBased_HEEP", LepGood_cutBased_HEEP, &b_LepGood_cutBased_HEEP);
   fChain->SetBranchAddress("LepGood_hoe", LepGood_hoe, &b_LepGood_hoe);
   ...
   fChain->SetBranchAddress("LepGood_miniPFRelIso_all", LepGood_miniPFRelIso_all, &b_LepGood_miniPFRelIso_all);
   fChain->SetBranchAddress("LepGood_vidNestedWPBitmap", LepGood_vidNestedWPBitmap, &b_LepGood_vidNestedWPBitmap);
   fChain->SetBranchAddress("LepGood_pfRelIso03_chg", LepGood_pfRelIso03_chg, &b_LepGood_pfRelIso03_chg);
   fChain->SetBranchAddress("LepGood_lostHits", LepGood_lostHits, &b_LepGood_lostHits);
   fChain->SetBranchAddress("LepGood_mvaFall17V2noIso_WPL", LepGood_mvaFall17V2noIso_WPL, &b_LepGood_mvaFall17V2noIso_WPL);
   fChain->SetBranchAddress("LepGood_mvaFall17V1noIso_WP90", LepGood_mvaFall17V1noIso_WP90, &b_LepGood_mvaFall17V1noIso_WP90);
   fChain->SetBranchAddress("LepGood_dxyErr", LepGood_dxyErr, &b_LepGood_dxyErr);
   fChain->SetBranchAddress("LepGood_mvaFall17V2Iso_WP80", LepGood_mvaFall17V2Iso_WP80, &b_LepGood_mvaFall17V2Iso_WP80);
   ...
   fChain->SetBranchAddress("LepGood_inTimeMuon", LepGood_inTimeMuon, &b_LepGood_inTimeMuon);
   fChain->SetBranchAddress("LepGood_mvaFall17V1noIso", LepGood_mvaFall17V1noIso, &b_LepGood_mvaFall17V1noIso);
   fChain->SetBranchAddress("LepGood_segmentComp", LepGood_segmentComp, &b_LepGood_segmentComp);
   fChain->SetBranchAddress("LepGood_mvaTTH", LepGood_mvaTTH, &b_LepGood_mvaTTH);
   fChain->SetBranchAddress("LepGood_mvaFall17V1noIso_WP80", LepGood_mvaFall17V1noIso_WP80, &b_LepGood_mvaFall17V1noIso_WP80);
   fChain->SetBranchAddress("LepGood_isPFcand", LepGood_isPFcand, &b_LepGood_isPFcand);
   fChain->SetBranchAddress("LepGood_mvaFall17V1Iso_WP80", LepGood_mvaFall17V1Iso_WP80, &b_LepGood_mvaFall17V1Iso_WP80);
   fChain->SetBranchAddress("LepGood_dr03TkSumPtHEEP", LepGood_dr03TkSumPtHEEP, &b_LepGood_dr03TkSumPtHEEP);
   fChain->SetBranchAddress("LepGood_triggerIdLoose", LepGood_triggerIdLoose, &b_LepGood_triggerIdLoose);
   fChain->SetBranchAddress("LepGood_mvaFall17V2noIso_WP90", LepGood_mvaFall17V2noIso_WP90, &b_LepGood_mvaFall17V2noIso_WP90);
   fChain->SetBranchAddress("LepGood_eInvMinusPInv", LepGood_eInvMinusPInv, &b_LepGood_eInvMinusPInv);
   fChain->SetBranchAddress("LepGood_mediumPromptId", LepGood_mediumPromptId, &b_LepGood_mediumPromptId);
   fChain->SetBranchAddress("LepGood_softMvaId", LepGood_softMvaId, &b_LepGood_softMvaId);
   fChain->SetBranchAddress("LepGood_photonIdx", LepGood_photonIdx, &b_LepGood_photonIdx);
   fChain->SetBranchAddress("LepGood_mvaFall17V2noIso", LepGood_mvaFall17V2noIso, &b_LepGood_mvaFall17V2noIso);
   fChain->SetBranchAddress("LepGood_dr03HcalDepth1TowerSumEt", LepGood_dr03HcalDepth1TowerSumEt, &b_LepGood_dr03HcalDepth1TowerSumEt);
   fChain->SetBranchAddress("LepGood_isGlobal", LepGood_isGlobal, &b_LepGood_isGlobal);
   fChain->SetBranchAddress("LepGood_looseId", LepGood_looseId, &b_LepGood_looseId);
   fChain->SetBranchAddress("LepGood_mvaLowPt", LepGood_mvaLowPt, &b_LepGood_mvaLowPt);
   fChain->SetBranchAddress("LepGood_nTrackerLayers", LepGood_nTrackerLayers, &b_LepGood_nTrackerLayers);
   fChain->SetBranchAddress("LepGood_dz", LepGood_dz, &b_LepGood_dz);
   fChain->SetBranchAddress("LepGood_isTracker", LepGood_isTracker, &b_LepGood_isTracker);
   fChain->SetBranchAddress("LepGood_sip3d", LepGood_sip3d, &b_LepGood_sip3d);
   fChain->SetBranchAddress("LepGood_highPtId", LepGood_highPtId, &b_LepGood_highPtId);
   fChain->SetBranchAddress("LepGood_tkRelIso", LepGood_tkRelIso, &b_LepGood_tkRelIso);
   fChain->SetBranchAddress("LepGood_tightId", LepGood_tightId, &b_LepGood_tightId);
   fChain->SetBranchAddress("LepGood_mvaFall17V2Iso_WPL", LepGood_mvaFall17V2Iso_WPL, &b_LepGood_mvaFall17V2Iso_WPL);
   fChain->SetBranchAddress("LepGood_pfRelIso04_all", LepGood_pfRelIso04_all, &b_LepGood_pfRelIso04_all);
   fChain->SetBranchAddress("LepGood_tkIsoId", LepGood_tkIsoId, &b_LepGood_tkIsoId);
   fChain->SetBranchAddress("LepGood_sieie", LepGood_sieie, &b_LepGood_sieie);
   fChain->SetBranchAddress("LepGood_cutBased", LepGood_cutBased, &b_LepGood_cutBased);
   fChain->SetBranchAddress("LepGood_deltaEtaSC", LepGood_deltaEtaSC, &b_LepGood_deltaEtaSC);
   fChain->SetBranchAddress("LepGood_cutBased_Fall17_V1", LepGood_cutBased_Fall17_V1, &b_LepGood_cutBased_Fall17_V1);
   fChain->SetBranchAddress("LepGood_ptErr", LepGood_ptErr, &b_LepGood_ptErr);
   fChain->SetBranchAddress("LepGood_r9", LepGood_r9, &b_LepGood_r9);
   fChain->SetBranchAddress("LepGood_eCorr", LepGood_eCorr, &b_LepGood_eCorr);
   fChain->SetBranchAddress("LepGood_genPartFlav", LepGood_genPartFlav, &b_LepGood_genPartFlav);
   fChain->SetBranchAddress("LepGood_pfIsoId", LepGood_pfIsoId, &b_LepGood_pfIsoId);
   fChain->SetBranchAddress("LepGood_seedGain", LepGood_seedGain, &b_LepGood_seedGain);
   ...
   fChain->SetBranchAddress("LepGood_mediumId", LepGood_mediumId, &b_LepGood_mediumId);
   fChain->SetBranchAddress("LepGood_mvaFall17V2Iso_WP90", LepGood_mvaFall17V2Iso_WP90, &b_LepGood_mvaFall17V2Iso_WP90);
   fChain->SetBranchAddress("LepGood_mvaFall17V1noIso_WPL", LepGood_mvaFall17V1noIso_WPL, &b_LepGood_mvaFall17V1noIso_WPL);
   fChain->SetBranchAddress("LepGood_genPartIdx", LepGood_genPartIdx, &b_LepGood_genPartIdx);
   fChain->SetBranchAddress("LepGood_mvaFall17V2noIso_WP80", LepGood_mvaFall17V2noIso_WP80, &b_LepGood_mvaFall17V2noIso_WP80);
   fChain->SetBranchAddress("LepGood_jetIdx", LepGood_jetIdx, &b_LepGood_jetIdx);
   fChain->SetBranchAddress("LepGood_miniIsoId", LepGood_miniIsoId, &b_LepGood_miniIsoId);
   fChain->SetBranchAddress("LepGood_mvaFall17V1Iso", LepGood_mvaFall17V1Iso, &b_LepGood_mvaFall17V1Iso);
   ...
   fChain->SetBranchAddress("LepGood_jetBTagDeepCSV", LepGood_jetBTagDeepCSV, &b_LepGood_jetBTagDeepCSV);
   ...
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_30", &GenModel_TChiWZ_ZToLL_150_30, &b_GenModel_TChiWZ_ZToLL_150_30);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_210", &GenModel_TChiWZ_ZToLL_250_210, &b_GenModel_TChiWZ_ZToLL_250_210);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_172", &GenModel_TChiWZ_ZToLL_175_172, &b_GenModel_TChiWZ_ZToLL_175_172);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_265", &GenModel_TChiWZ_ZToLL_275_265, &b_GenModel_TChiWZ_ZToLL_275_265);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_100_97", &GenModel_TChiWZ_ZToLL_100_97, &b_GenModel_TChiWZ_ZToLL_100_97);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_299", &GenModel_TChiWZ_ZToLL_300_299, &b_GenModel_TChiWZ_ZToLL_300_299);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_192", &GenModel_TChiWZ_ZToLL_200_192, &b_GenModel_TChiWZ_ZToLL_200_192);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_125_95", &GenModel_TChiWZ_ZToLL_125_95, &b_GenModel_TChiWZ_ZToLL_125_95);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_1", &GenModel_TChiWZ_ZToLL_325_1, &b_GenModel_TChiWZ_ZToLL_325_1);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_224", &GenModel_TChiWZ_ZToLL_225_224, &b_GenModel_TChiWZ_ZToLL_225_224);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_185", &GenModel_TChiWZ_ZToLL_200_185, &b_GenModel_TChiWZ_ZToLL_200_185);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_135", &GenModel_TChiWZ_ZToLL_225_135, &b_GenModel_TChiWZ_ZToLL_225_135);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_20", &GenModel_TChiWZ_ZToLL_150_20, &b_GenModel_TChiWZ_ZToLL_150_20);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_170", &GenModel_TChiWZ_ZToLL_300_170, &b_GenModel_TChiWZ_ZToLL_300_170);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_125_65", &GenModel_TChiWZ_ZToLL_125_65, &b_GenModel_TChiWZ_ZToLL_125_65);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_185", &GenModel_TChiWZ_ZToLL_225_185, &b_GenModel_TChiWZ_ZToLL_225_185);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_292", &GenModel_TChiWZ_ZToLL_300_292, &b_GenModel_TChiWZ_ZToLL_300_292);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_297", &GenModel_TChiWZ_ZToLL_300_297, &b_GenModel_TChiWZ_ZToLL_300_297);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_125_122", &GenModel_TChiWZ_ZToLL_125_122, &b_GenModel_TChiWZ_ZToLL_125_122);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_235", &GenModel_TChiWZ_ZToLL_275_235, &b_GenModel_TChiWZ_ZToLL_275_235);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_242", &GenModel_TChiWZ_ZToLL_250_242, &b_GenModel_TChiWZ_ZToLL_250_242);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_240", &GenModel_TChiWZ_ZToLL_250_240, &b_GenModel_TChiWZ_ZToLL_250_240);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_140", &GenModel_TChiWZ_ZToLL_200_140, &b_GenModel_TChiWZ_ZToLL_200_140);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_145", &GenModel_TChiWZ_ZToLL_150_145, &b_GenModel_TChiWZ_ZToLL_150_145);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_295", &GenModel_TChiWZ_ZToLL_325_295, &b_GenModel_TChiWZ_ZToLL_325_295);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_105", &GenModel_TChiWZ_ZToLL_175_105, &b_GenModel_TChiWZ_ZToLL_175_105);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_160", &GenModel_TChiWZ_ZToLL_175_160, &b_GenModel_TChiWZ_ZToLL_175_160);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_170", &GenModel_TChiWZ_ZToLL_250_170, &b_GenModel_TChiWZ_ZToLL_250_170);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_285", &GenModel_TChiWZ_ZToLL_300_285, &b_GenModel_TChiWZ_ZToLL_300_285);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_120", &GenModel_TChiWZ_ZToLL_150_120, &b_GenModel_TChiWZ_ZToLL_150_120);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_265", &GenModel_TChiWZ_ZToLL_325_265, &b_GenModel_TChiWZ_ZToLL_325_265);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_175", &GenModel_TChiWZ_ZToLL_275_175, &b_GenModel_TChiWZ_ZToLL_275_175);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_50", &GenModel_TChiWZ_ZToLL_225_50, &b_GenModel_TChiWZ_ZToLL_225_50);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_205", &GenModel_TChiWZ_ZToLL_275_205, &b_GenModel_TChiWZ_ZToLL_275_205);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_260", &GenModel_TChiWZ_ZToLL_300_260, &b_GenModel_TChiWZ_ZToLL_300_260);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_75", &GenModel_TChiWZ_ZToLL_325_75, &b_GenModel_TChiWZ_ZToLL_325_75);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_75", &GenModel_TChiWZ_ZToLL_300_75, &b_GenModel_TChiWZ_ZToLL_300_75);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_135", &GenModel_TChiWZ_ZToLL_175_135, &b_GenModel_TChiWZ_ZToLL_175_135);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_160", &GenModel_TChiWZ_ZToLL_250_160, &b_GenModel_TChiWZ_ZToLL_250_160);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_75", &GenModel_TChiWZ_ZToLL_275_75, &b_GenModel_TChiWZ_ZToLL_275_75);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_225", &GenModel_TChiWZ_ZToLL_275_225, &b_GenModel_TChiWZ_ZToLL_275_225);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_145", &GenModel_TChiWZ_ZToLL_275_145, &b_GenModel_TChiWZ_ZToLL_275_145);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_180", &GenModel_TChiWZ_ZToLL_250_180, &b_GenModel_TChiWZ_ZToLL_250_180);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_190", &GenModel_TChiWZ_ZToLL_300_190, &b_GenModel_TChiWZ_ZToLL_300_190);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_255", &GenModel_TChiWZ_ZToLL_275_255, &b_GenModel_TChiWZ_ZToLL_275_255);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_270", &GenModel_TChiWZ_ZToLL_300_270, &b_GenModel_TChiWZ_ZToLL_300_270);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_270", &GenModel_TChiWZ_ZToLL_275_270, &b_GenModel_TChiWZ_ZToLL_275_270);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_272", &GenModel_TChiWZ_ZToLL_275_272, &b_GenModel_TChiWZ_ZToLL_275_272);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_125_117", &GenModel_TChiWZ_ZToLL_125_117, &b_GenModel_TChiWZ_ZToLL_125_117);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_100", &GenModel_TChiWZ_ZToLL_325_100, &b_GenModel_TChiWZ_ZToLL_325_100);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_145", &GenModel_TChiWZ_ZToLL_225_145, &b_GenModel_TChiWZ_ZToLL_225_145);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_180", &GenModel_TChiWZ_ZToLL_300_180, &b_GenModel_TChiWZ_ZToLL_300_180);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_100_30", &GenModel_TChiWZ_ZToLL_100_30, &b_GenModel_TChiWZ_ZToLL_100_30);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_200", &GenModel_TChiWZ_ZToLL_250_200, &b_GenModel_TChiWZ_ZToLL_250_200);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_125_110", &GenModel_TChiWZ_ZToLL_125_110, &b_GenModel_TChiWZ_ZToLL_125_110);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_220", &GenModel_TChiWZ_ZToLL_250_220, &b_GenModel_TChiWZ_ZToLL_250_220);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_260", &GenModel_TChiWZ_ZToLL_275_260, &b_GenModel_TChiWZ_ZToLL_275_260);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_210", &GenModel_TChiWZ_ZToLL_300_210, &b_GenModel_TChiWZ_ZToLL_300_210);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_225", &GenModel_TChiWZ_ZToLL_325_225, &b_GenModel_TChiWZ_ZToLL_325_225);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_165", &GenModel_TChiWZ_ZToLL_275_165, &b_GenModel_TChiWZ_ZToLL_275_165);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_197", &GenModel_TChiWZ_ZToLL_200_197, &b_GenModel_TChiWZ_ZToLL_200_197);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_247", &GenModel_TChiWZ_ZToLL_250_247, &b_GenModel_TChiWZ_ZToLL_250_247);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_100_92", &GenModel_TChiWZ_ZToLL_100_92, &b_GenModel_TChiWZ_ZToLL_100_92);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_100_80", &GenModel_TChiWZ_ZToLL_100_80, &b_GenModel_TChiWZ_ZToLL_100_80);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_235", &GenModel_TChiWZ_ZToLL_250_235, &b_GenModel_TChiWZ_ZToLL_250_235);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_195", &GenModel_TChiWZ_ZToLL_225_195, &b_GenModel_TChiWZ_ZToLL_225_195);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_215", &GenModel_TChiWZ_ZToLL_225_215, &b_GenModel_TChiWZ_ZToLL_225_215);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_100_40", &GenModel_TChiWZ_ZToLL_100_40, &b_GenModel_TChiWZ_ZToLL_100_40);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_85", &GenModel_TChiWZ_ZToLL_175_85, &b_GenModel_TChiWZ_ZToLL_175_85);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_125", &GenModel_TChiWZ_ZToLL_225_125, &b_GenModel_TChiWZ_ZToLL_225_125);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_50", &GenModel_TChiWZ_ZToLL_275_50, &b_GenModel_TChiWZ_ZToLL_275_50);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_125_35", &GenModel_TChiWZ_ZToLL_125_35, &b_GenModel_TChiWZ_ZToLL_125_35);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_135", &GenModel_TChiWZ_ZToLL_150_135, &b_GenModel_TChiWZ_ZToLL_150_135);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_274", &GenModel_TChiWZ_ZToLL_275_274, &b_GenModel_TChiWZ_ZToLL_275_274);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_295", &GenModel_TChiWZ_ZToLL_300_295, &b_GenModel_TChiWZ_ZToLL_300_295);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_1", &GenModel_TChiWZ_ZToLL_250_1, &b_GenModel_TChiWZ_ZToLL_250_1);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_1", &GenModel_TChiWZ_ZToLL_200_1, &b_GenModel_TChiWZ_ZToLL_200_1);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_215", &GenModel_TChiWZ_ZToLL_275_215, &b_GenModel_TChiWZ_ZToLL_275_215);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_175", &GenModel_TChiWZ_ZToLL_325_175, &b_GenModel_TChiWZ_ZToLL_325_175);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_147", &GenModel_TChiWZ_ZToLL_150_147, &b_GenModel_TChiWZ_ZToLL_150_147);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_100_70", &GenModel_TChiWZ_ZToLL_100_70, &b_GenModel_TChiWZ_ZToLL_100_70);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_222", &GenModel_TChiWZ_ZToLL_225_222, &b_GenModel_TChiWZ_ZToLL_225_222);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_245", &GenModel_TChiWZ_ZToLL_325_245, &b_GenModel_TChiWZ_ZToLL_325_245);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_50", &GenModel_TChiWZ_ZToLL_325_50, &b_GenModel_TChiWZ_ZToLL_325_50);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_125", &GenModel_TChiWZ_ZToLL_175_125, &b_GenModel_TChiWZ_ZToLL_175_125);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_120", &GenModel_TChiWZ_ZToLL_200_120, &b_GenModel_TChiWZ_ZToLL_200_120);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_235", &GenModel_TChiWZ_ZToLL_325_235, &b_GenModel_TChiWZ_ZToLL_325_235);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_190", &GenModel_TChiWZ_ZToLL_250_190, &b_GenModel_TChiWZ_ZToLL_250_190);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_250", &GenModel_TChiWZ_ZToLL_300_250, &b_GenModel_TChiWZ_ZToLL_300_250);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_100_10", &GenModel_TChiWZ_ZToLL_100_10, &b_GenModel_TChiWZ_ZToLL_100_10);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_190", &GenModel_TChiWZ_ZToLL_200_190, &b_GenModel_TChiWZ_ZToLL_200_190);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_85", &GenModel_TChiWZ_ZToLL_225_85, &b_GenModel_TChiWZ_ZToLL_225_85);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_145", &GenModel_TChiWZ_ZToLL_175_145, &b_GenModel_TChiWZ_ZToLL_175_145);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_10", &GenModel_TChiWZ_ZToLL_150_10, &b_GenModel_TChiWZ_ZToLL_150_10);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_170", &GenModel_TChiWZ_ZToLL_175_170, &b_GenModel_TChiWZ_ZToLL_175_170);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_170", &GenModel_TChiWZ_ZToLL_200_170, &b_GenModel_TChiWZ_ZToLL_200_170);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_125", &GenModel_TChiWZ_ZToLL_275_125, &b_GenModel_TChiWZ_ZToLL_275_125);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_155", &GenModel_TChiWZ_ZToLL_275_155, &b_GenModel_TChiWZ_ZToLL_275_155);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_174", &GenModel_TChiWZ_ZToLL_175_174, &b_GenModel_TChiWZ_ZToLL_175_174);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_100_50", &GenModel_TChiWZ_ZToLL_100_50, &b_GenModel_TChiWZ_ZToLL_100_50);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_125", &GenModel_TChiWZ_ZToLL_300_125, &b_GenModel_TChiWZ_ZToLL_300_125);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_280", &GenModel_TChiWZ_ZToLL_300_280, &b_GenModel_TChiWZ_ZToLL_300_280);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_230", &GenModel_TChiWZ_ZToLL_250_230, &b_GenModel_TChiWZ_ZToLL_250_230);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_65", &GenModel_TChiWZ_ZToLL_175_65, &b_GenModel_TChiWZ_ZToLL_175_65);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_125_115", &GenModel_TChiWZ_ZToLL_125_115, &b_GenModel_TChiWZ_ZToLL_125_115);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_135", &GenModel_TChiWZ_ZToLL_275_135, &b_GenModel_TChiWZ_ZToLL_275_135);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_100_95", &GenModel_TChiWZ_ZToLL_100_95, &b_GenModel_TChiWZ_ZToLL_100_95);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_215", &GenModel_TChiWZ_ZToLL_325_215, &b_GenModel_TChiWZ_ZToLL_325_215);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_195", &GenModel_TChiWZ_ZToLL_275_195, &b_GenModel_TChiWZ_ZToLL_275_195);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_220", &GenModel_TChiWZ_ZToLL_225_220, &b_GenModel_TChiWZ_ZToLL_225_220);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_70", &GenModel_TChiWZ_ZToLL_200_70, &b_GenModel_TChiWZ_ZToLL_200_70);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_290", &GenModel_TChiWZ_ZToLL_300_290, &b_GenModel_TChiWZ_ZToLL_300_290);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_140", &GenModel_TChiWZ_ZToLL_250_140, &b_GenModel_TChiWZ_ZToLL_250_140);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_200", &GenModel_TChiWZ_ZToLL_300_200, &b_GenModel_TChiWZ_ZToLL_300_200);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_125_75", &GenModel_TChiWZ_ZToLL_125_75, &b_GenModel_TChiWZ_ZToLL_125_75);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_125_120", &GenModel_TChiWZ_ZToLL_125_120, &b_GenModel_TChiWZ_ZToLL_125_120);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_100", &GenModel_TChiWZ_ZToLL_150_100, &b_GenModel_TChiWZ_ZToLL_150_100);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_160", &GenModel_TChiWZ_ZToLL_300_160, &b_GenModel_TChiWZ_ZToLL_300_160);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_267", &GenModel_TChiWZ_ZToLL_275_267, &b_GenModel_TChiWZ_ZToLL_275_267);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_100_85", &GenModel_TChiWZ_ZToLL_100_85, &b_GenModel_TChiWZ_ZToLL_100_85);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_245", &GenModel_TChiWZ_ZToLL_250_245, &b_GenModel_TChiWZ_ZToLL_250_245);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_105", &GenModel_TChiWZ_ZToLL_225_105, &b_GenModel_TChiWZ_ZToLL_225_105);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_160", &GenModel_TChiWZ_ZToLL_200_160, &b_GenModel_TChiWZ_ZToLL_200_160);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_175", &GenModel_TChiWZ_ZToLL_225_175, &b_GenModel_TChiWZ_ZToLL_225_175);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_1", &GenModel_TChiWZ_ZToLL_300_1, &b_GenModel_TChiWZ_ZToLL_300_1);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_40", &GenModel_TChiWZ_ZToLL_150_40, &b_GenModel_TChiWZ_ZToLL_150_40);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_25", &GenModel_TChiWZ_ZToLL_225_25, &b_GenModel_TChiWZ_ZToLL_225_25);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_100", &GenModel_TChiWZ_ZToLL_275_100, &b_GenModel_TChiWZ_ZToLL_275_100);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_150", &GenModel_TChiWZ_ZToLL_200_150, &b_GenModel_TChiWZ_ZToLL_200_150);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_195", &GenModel_TChiWZ_ZToLL_200_195, &b_GenModel_TChiWZ_ZToLL_200_195);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_110", &GenModel_TChiWZ_ZToLL_250_110, &b_GenModel_TChiWZ_ZToLL_250_110);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_100_90", &GenModel_TChiWZ_ZToLL_100_90, &b_GenModel_TChiWZ_ZToLL_100_90);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_150", &GenModel_TChiWZ_ZToLL_300_150, &b_GenModel_TChiWZ_ZToLL_300_150);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_285", &GenModel_TChiWZ_ZToLL_325_285, &b_GenModel_TChiWZ_ZToLL_325_285);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_125", &GenModel_TChiWZ_ZToLL_325_125, &b_GenModel_TChiWZ_ZToLL_325_125);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_100", &GenModel_TChiWZ_ZToLL_200_100, &b_GenModel_TChiWZ_ZToLL_200_100);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_1", &GenModel_TChiWZ_ZToLL_175_1, &b_GenModel_TChiWZ_ZToLL_175_1);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_25", &GenModel_TChiWZ_ZToLL_325_25, &b_GenModel_TChiWZ_ZToLL_325_25);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_217", &GenModel_TChiWZ_ZToLL_225_217, &b_GenModel_TChiWZ_ZToLL_225_217);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_249", &GenModel_TChiWZ_ZToLL_250_249, &b_GenModel_TChiWZ_ZToLL_250_249);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_110", &GenModel_TChiWZ_ZToLL_200_110, &b_GenModel_TChiWZ_ZToLL_200_110);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_165", &GenModel_TChiWZ_ZToLL_225_165, &b_GenModel_TChiWZ_ZToLL_225_165);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_245", &GenModel_TChiWZ_ZToLL_275_245, &b_GenModel_TChiWZ_ZToLL_275_245);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_125_5", &GenModel_TChiWZ_ZToLL_125_5, &b_GenModel_TChiWZ_ZToLL_125_5);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_130", &GenModel_TChiWZ_ZToLL_250_130, &b_GenModel_TChiWZ_ZToLL_250_130);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_125_45", &GenModel_TChiWZ_ZToLL_125_45, &b_GenModel_TChiWZ_ZToLL_125_45);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_50", &GenModel_TChiWZ_ZToLL_300_50, &b_GenModel_TChiWZ_ZToLL_300_50);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_100_60", &GenModel_TChiWZ_ZToLL_100_60, &b_GenModel_TChiWZ_ZToLL_100_60);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_125_105", &GenModel_TChiWZ_ZToLL_125_105, &b_GenModel_TChiWZ_ZToLL_125_105);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_100", &GenModel_TChiWZ_ZToLL_250_100, &b_GenModel_TChiWZ_ZToLL_250_100);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_25", &GenModel_TChiWZ_ZToLL_200_25, &b_GenModel_TChiWZ_ZToLL_200_25);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_149", &GenModel_TChiWZ_ZToLL_150_149, &b_GenModel_TChiWZ_ZToLL_150_149);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_100_1", &GenModel_TChiWZ_ZToLL_100_1, &b_GenModel_TChiWZ_ZToLL_100_1);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_199", &GenModel_TChiWZ_ZToLL_200_199, &b_GenModel_TChiWZ_ZToLL_200_199);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_25", &GenModel_TChiWZ_ZToLL_175_25, &b_GenModel_TChiWZ_ZToLL_175_25);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_110", &GenModel_TChiWZ_ZToLL_150_110, &b_GenModel_TChiWZ_ZToLL_150_110);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_167", &GenModel_TChiWZ_ZToLL_175_167, &b_GenModel_TChiWZ_ZToLL_175_167);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_115", &GenModel_TChiWZ_ZToLL_225_115, &b_GenModel_TChiWZ_ZToLL_225_115);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_100_20", &GenModel_TChiWZ_ZToLL_100_20, &b_GenModel_TChiWZ_ZToLL_100_20);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_205", &GenModel_TChiWZ_ZToLL_325_205, &b_GenModel_TChiWZ_ZToLL_325_205);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_155", &GenModel_TChiWZ_ZToLL_175_155, &b_GenModel_TChiWZ_ZToLL_175_155);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_25", &GenModel_TChiWZ_ZToLL_300_25, &b_GenModel_TChiWZ_ZToLL_300_25);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_275", &GenModel_TChiWZ_ZToLL_325_275, &b_GenModel_TChiWZ_ZToLL_325_275);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_125_85", &GenModel_TChiWZ_ZToLL_125_85, &b_GenModel_TChiWZ_ZToLL_125_85);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_1", &GenModel_TChiWZ_ZToLL_275_1, &b_GenModel_TChiWZ_ZToLL_275_1);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_185", &GenModel_TChiWZ_ZToLL_325_185, &b_GenModel_TChiWZ_ZToLL_325_185);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_240", &GenModel_TChiWZ_ZToLL_300_240, &b_GenModel_TChiWZ_ZToLL_300_240);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_220", &GenModel_TChiWZ_ZToLL_300_220, &b_GenModel_TChiWZ_ZToLL_300_220);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_155", &GenModel_TChiWZ_ZToLL_225_155, &b_GenModel_TChiWZ_ZToLL_225_155);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_125_124", &GenModel_TChiWZ_ZToLL_125_124, &b_GenModel_TChiWZ_ZToLL_125_124);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_90", &GenModel_TChiWZ_ZToLL_200_90, &b_GenModel_TChiWZ_ZToLL_200_90);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_75", &GenModel_TChiWZ_ZToLL_225_75, &b_GenModel_TChiWZ_ZToLL_225_75);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_50", &GenModel_TChiWZ_ZToLL_250_50, &b_GenModel_TChiWZ_ZToLL_250_50);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_70", &GenModel_TChiWZ_ZToLL_150_70, &b_GenModel_TChiWZ_ZToLL_150_70);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_130", &GenModel_TChiWZ_ZToLL_200_130, &b_GenModel_TChiWZ_ZToLL_200_130);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_125_15", &GenModel_TChiWZ_ZToLL_125_15, &b_GenModel_TChiWZ_ZToLL_125_15);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_125_25", &GenModel_TChiWZ_ZToLL_125_25, &b_GenModel_TChiWZ_ZToLL_125_25);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_180", &GenModel_TChiWZ_ZToLL_200_180, &b_GenModel_TChiWZ_ZToLL_200_180);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_90", &GenModel_TChiWZ_ZToLL_150_90, &b_GenModel_TChiWZ_ZToLL_150_90);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_185", &GenModel_TChiWZ_ZToLL_275_185, &b_GenModel_TChiWZ_ZToLL_275_185);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_150", &GenModel_TChiWZ_ZToLL_325_150, &b_GenModel_TChiWZ_ZToLL_325_150);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_125_55", &GenModel_TChiWZ_ZToLL_125_55, &b_GenModel_TChiWZ_ZToLL_125_55);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_35", &GenModel_TChiWZ_ZToLL_175_35, &b_GenModel_TChiWZ_ZToLL_175_35);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_255", &GenModel_TChiWZ_ZToLL_325_255, &b_GenModel_TChiWZ_ZToLL_325_255);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_120", &GenModel_TChiWZ_ZToLL_250_120, &b_GenModel_TChiWZ_ZToLL_250_120);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_230", &GenModel_TChiWZ_ZToLL_300_230, &b_GenModel_TChiWZ_ZToLL_300_230);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_80", &GenModel_TChiWZ_ZToLL_200_80, &b_GenModel_TChiWZ_ZToLL_200_80);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_95", &GenModel_TChiWZ_ZToLL_225_95, &b_GenModel_TChiWZ_ZToLL_225_95);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_142", &GenModel_TChiWZ_ZToLL_150_142, &b_GenModel_TChiWZ_ZToLL_150_142);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_325_195", &GenModel_TChiWZ_ZToLL_325_195, &b_GenModel_TChiWZ_ZToLL_325_195);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_150", &GenModel_TChiWZ_ZToLL_250_150, &b_GenModel_TChiWZ_ZToLL_250_150);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_115", &GenModel_TChiWZ_ZToLL_175_115, &b_GenModel_TChiWZ_ZToLL_175_115);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_95", &GenModel_TChiWZ_ZToLL_175_95, &b_GenModel_TChiWZ_ZToLL_175_95);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_60", &GenModel_TChiWZ_ZToLL_200_60, &b_GenModel_TChiWZ_ZToLL_200_60);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_200_50", &GenModel_TChiWZ_ZToLL_200_50, &b_GenModel_TChiWZ_ZToLL_200_50);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_225_1", &GenModel_TChiWZ_ZToLL_225_1, &b_GenModel_TChiWZ_ZToLL_225_1);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_300_100", &GenModel_TChiWZ_ZToLL_300_100, &b_GenModel_TChiWZ_ZToLL_300_100);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_55", &GenModel_TChiWZ_ZToLL_175_55, &b_GenModel_TChiWZ_ZToLL_175_55);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_50", &GenModel_TChiWZ_ZToLL_150_50, &b_GenModel_TChiWZ_ZToLL_150_50);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_75", &GenModel_TChiWZ_ZToLL_175_75, &b_GenModel_TChiWZ_ZToLL_175_75);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_80", &GenModel_TChiWZ_ZToLL_150_80, &b_GenModel_TChiWZ_ZToLL_150_80);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_100_99", &GenModel_TChiWZ_ZToLL_100_99, &b_GenModel_TChiWZ_ZToLL_100_99);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_130", &GenModel_TChiWZ_ZToLL_150_130, &b_GenModel_TChiWZ_ZToLL_150_130);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_250_75", &GenModel_TChiWZ_ZToLL_250_75, &b_GenModel_TChiWZ_ZToLL_250_75);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_60", &GenModel_TChiWZ_ZToLL_150_60, &b_GenModel_TChiWZ_ZToLL_150_60);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_175_45", &GenModel_TChiWZ_ZToLL_175_45, &b_GenModel_TChiWZ_ZToLL_175_45);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_275_25", &GenModel_TChiWZ_ZToLL_275_25, &b_GenModel_TChiWZ_ZToLL_275_25);
   fChain->SetBranchAddress("GenModel_TChiWZ_ZToLL_150_1", &GenModel_TChiWZ_ZToLL_150_1, &b_GenModel_TChiWZ_ZToLL_150_1);
   Notify();
}
